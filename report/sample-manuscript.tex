...
\EndFunction
\end{algorithmic}
\caption{Pseudocode for the genetic algorithm network generation procedure. \Call{Crossover}{} performs single-point route-set crossover; \Call{Mutate}{} applies one of three operators (rewire, insert, or remove) to a randomly chosen line.}
...
network & \texttt{graph.pkl}, \texttt{positions.pkl}, \texttt{kde.pkl} & Gabriel graph + KDE scoring \\
gnn\_scoring & \texttt{gnn\_scores.pkl}, updated \texttt{graph.pkl} & Multi-hop graph aggregation re-scoring \\
